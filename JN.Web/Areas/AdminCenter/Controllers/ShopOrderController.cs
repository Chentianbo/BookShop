...
namespace JN.Web.Areas.AdminCenter.Controllers
{
    ...
    public class ShopOrderController : BaseController
    {
        ...
        {
            ActMessage = "订单管理";
            var list = _shopOrderService.List(x => x.Status == (state ?? 1)).WhereDynamic(FormatQueryString(HttpUtility.ParseQueryString(Request.Url.Query))).ToList();
            ...
            //枚举数据
            ViewBag.EnumData = EnumExtension.GetOptions(OrderStatus.AlreadyPaid);
