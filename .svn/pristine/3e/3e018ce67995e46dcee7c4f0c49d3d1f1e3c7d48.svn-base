...
{
    public class ActLogAttribute : ActionFilterAttribute
    {
        ...
        //类型名称
        private string _actLogTypeName = "";
        ...
        public ActLogAttribute(string activityLogTypeName, string parm)
        {
            _actLogTypeName = activityLogTypeName;
