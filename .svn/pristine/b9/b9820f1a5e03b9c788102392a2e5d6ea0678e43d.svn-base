...
namespace JN.Services.Tool
{
    public class StringHelp
    {
        ...
        {
            Regex objPhone = new Regex("^0?(13[0-9]|15[012356789]|18[0236789]|14[57])[0-9]{8}$");
            return objPhone.IsMatch(strPhone);
        }

        /// <summary>判断string类型否为固定电话号
        /// 
        /// </summary>
        ...
        public static string GetParamHits(string s, int index)
        {
            ...
            return "<span class=\"label\">" + s.Split(',')[index] + "</span>";
        }
    }
